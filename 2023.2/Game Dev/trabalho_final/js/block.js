...
export default class Block extends me.Entity {
    constructor(x, y, isbomb, update) {
      ...
      // Set the gravity to 0 so the block is not affected by gravity
      this.body.gravity = 0;
  
      let blockImage = me.loader.getImage("block");
    ...
    getNeighborBlocks() {
      ...
      for (let i = 0; i < blocks.length; i++) {
        ...
        // Check if the block is not the current block and is neighboring
