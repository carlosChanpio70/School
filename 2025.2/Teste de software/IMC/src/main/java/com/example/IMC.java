...
public final class IMC {
  ...
  public IMC() { this.calculo = new Calculo(); }

  public double getPeso() { return peso; }

  public double getAltura() { return altura; }

  public double getIMC() { return imcvalor; }

  public Calculo getCalculo() { return calculo; }

  public void setGenero(String genero) {
    Genero generoclass = new Genero(genero);
    this.imclista = generoclass.getIMCLista();
  }

  public void setPeso(double peso) { this.calculo.setPeso(peso); }

  public void setAltura(double altura) { this.calculo.setAltura(altura); }

  public void setIMC() { this.imcvalor = this.calculo.getCalculo(); }

  public void setCalculo() { this.calculo = new Calculo(peso, altura); }
