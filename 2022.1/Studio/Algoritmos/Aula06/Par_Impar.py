...
def main():
    ...
    if 0 <= play_select <= 1:
        ...
        while loop_range:
            ...
            play_2 = AI_Select_logic(AI_select,1)
            sum_1_2 = play_1 + play_2
            player_message = AI_Select_logic(AI_select,2)
...
def AI_Select_logic(AI_select,selection):
    if selection == 1:
        if AI_select:
            play_2 = randint(1,2)
            ...
            return int(input("Segundo jogador, escreva o seu número: "))
    else:
        if AI_select:
            return "Computador"
        else:
